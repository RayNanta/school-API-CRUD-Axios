              ...
              {this.state.pegawai.map((item, index) => {
                return (
                  <tr key={index}>
                    ...
                    <td>{item.alamat}</td>
                    <td>
                      <button className="btn btn-sm btn-primary m-1" data-toggle="modal" data-target="#modal" onClick={() => this.Edit(item)}>
                        Edit
                      </button>
              ...
              <div className="modal-content">
                ...
                <form onSubmit={this.SavePegawai}>
                  ...
                  <div className="modal-footer">
                    ...
                    <p className="btn btn-sm btn-danger" onClick={this.Close}>
                        Close
                    </p>
                  </div>
                </form>
